...
- Add provider detection for Onlinemail domains routing via `onlinemail.io` MX records, returning the expected webmail URL `https://www.onlinemail.io/`.
...
- Update npm dependencies (`npm update`; captured in `package-lock.json`).

## Quality
- All tests passing (1 skipped) under Node v25.2.1; build verified.

## Reference commits
- fix: update security hashes and prepare for release (4301519)
- fix: Added new providers (e9c81fe)
